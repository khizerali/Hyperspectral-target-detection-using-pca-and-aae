...
sess=tf.Session()
saver = tf.train.import_meta_graph('./model/salinas_c6_1bands/model.meta')
saver.restore(sess, tf.train.latest_checkpoint('./model/salinas_c6_1bands/'))
...
##########
load_fn = './data/salinas_c6_1bands1.mat'
...
save_fn = './result/salinas_c6_1bands/reconstruct_result_huber.mat'
