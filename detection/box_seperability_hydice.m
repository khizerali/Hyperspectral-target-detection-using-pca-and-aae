...
%% Load Results
clear all;
m=load('G:\khizer\hyperspectral_datasets\E_CEM-for-Hyperspectral-Target-Detection-master\hyperspectral_data\hydice_urban2.mat');
map=m.groundtruth;
...
%%
output=load('G:\khizer\hyperspectral_datasets\E_CEM-for-Hyperspectral-Target-Detection-master\MF_hydice_urban_output.mat')
 R1=output.output;
 
 output=load('G:\khizer\hyperspectral_datasets\E_CEM-for-Hyperspectral-Target-Detection-master\CEM_hydice_urban_output.mat')
 R2=output.output;
 
   output=load('G:\khizer\hyperspectral_datasets\E_CEM-for-Hyperspectral-Target-Detection-master\ACE_hydice_urban_output.mat')
 R3=output.output;
 
   output=load('G:\khizer\hyperspectral_datasets\E_CEM-for-Hyperspectral-Target-Detection-master\E-CEM_hydice_urban_output.mat')
 R4=output.output;
 
    output=load('E:\Compressed\hCEM_Demo\hydice_hcem.mat')
 R5=output.outputs;
 
      output=load('G:\khizer\HSI-detection-main\hydice-dmbdl.mat')
 R6=output.re;
 
      output=load('F:\BLTSC-master\New folder\bltsc_hydice.mat')
 R7=output.B;
 
        output=load('F:\BLTSC-master\New folder\proposed_hydice.mat');
 R8=output.B;
%% Normalized(0-1)
